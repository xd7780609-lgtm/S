...
import app.slipnet.presentation.scanner.ScannerScreen
import app.slipnet.presentation.scanner.ScannerImportScreen
    ...
    NavHost(
        ...
        composable(NavRoutes.Home.route) {
            MainScreen(
                ...
                onNavigateToScanner = {
                    navController.navigate(NavRoutes.CdnScanner.route)
                }
            )
        }
        ...
        // ========== CDN Scanner ==========
        composable(NavRoutes.CdnScanner.route) {
            ScannerScreen(
                onNavigateToImport = {
        ...
        composable(NavRoutes.CdnScannerImport.route) {
            ScannerImportScreen(
                onNavigateBack = {
                    navController.popBackStack()
                }
