...
RUN_DIR="${ROOT_DIR}/.interop/bench-c-c-$(date +%Y%m%d_%H%M%S)"
...
SLIPSTREAM_GSO="${SLIPSTREAM_GSO:-0}"
RUNS="${RUNS:-1}"
...
C_SERVER_BIN="${BUILD_DIR}/slipstream-server"
C_CLIENT_BIN="${BUILD_DIR}/slipstream-client"
